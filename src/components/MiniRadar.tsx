...
export const MiniRadar: React.FC<MiniRadarProps> = ({ onSelectCoordinate }) => {
  ...
  const handleClick = (e: React.MouseEvent) => {
    ...
    // Canvas is 300px, represents 40m total (20m radius)
    const maxMeters = 40;
  ...
  return (
    <div className="flex justify-center mb-6">
      <div 
        ref={radarRef}
        className="w-[200px] h-[200px] rounded-full border border-gray-500 bg-gray-900 relative cursor-crosshair"
        onClick={handleClick}
      >
        {/* Center */}
        <div className="absolute top-1/2 left-1/2 w-[6px] h-[6px] bg-white rounded-full translate-x-[-50%] translate-y-[-50%]" />
